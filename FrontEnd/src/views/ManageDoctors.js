...
function ManageDoctors() {
    ...
    const refreshArchivedList = () => {
        fetch(apiBaseUrl + "/users?role=DOCTOR&archived=1", {
            "method": "GET",
            "headers": {
                "content-type": "application/json",
                "accept": "application/json",
            ...
            <div className="content">
                <Row>
                    <Col md="12">
                        <Card>
                            <CardHeader>
                                <CardTitle style={{textAlign: "center"}} tag="h4">Liste des médecins</CardTitle>
                            </CardHeader>
                            <CardBody>
                    ...
                    <Col md="12">
                        <Card>
                            <CardHeader>
                                <CardTitle style={{textAlign: "center"}} tag="h4">Liste des médecins (Archivés)</CardTitle>
                            </CardHeader>
                            <CardBody>
                                <Form style={{padding: "12px"}}>
                                    <Row>
