...
function ManageLabTechnicians() {
    ...
    const refreshUnarchivedList = () => {
        fetch(apiBaseUrl + "/users?role=LAB_TECHNICIAN&archived=0", {
            "method": "GET",
            "headers": {
                "content-type": "application/json",
                "accept": "application/json",
    ...
    const refreshArchivedList = () => {
        fetch(apiBaseUrl + "/users?role=LAB_TECHNICIAN&archived=1", {
            "method": "GET",
            "headers": {
                "content-type": "application/json",
                "accept": "application/json",
            ...
            <div className="content">
                <Row>
                    <Col md="12">
                        <Card>
                            <CardHeader>
                                <CardTitle style={{textAlign: "center"}} tag="h4">Liste des techniciens Labo</CardTitle>
                            </CardHeader>
                            <CardBody>
                    ...
                    <Col md="12">
                        <Card>
                            <CardHeader>
                                <CardTitle style={{textAlign: "center"}} tag="h4">Liste des techniciens Labo (Archivés)</CardTitle>
                            </CardHeader>
                            <CardBody>
                                <Form style={{padding: "12px"}}>
                                    <Row>
