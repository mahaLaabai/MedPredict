...
function UpdateMedicalFolderForDoctor4() {
                                    ...
                                    <Row>
                                        <Col className="pr-1" md="10">
                                            <FormGroup style={{textAlign: "center"}}>
                                                ...
                                                <Input value={patient} type="text" name="patient" id="patientSelect"
...
export default UpdateMedicalFolderForDoctor4;
